...
export default props => {
  return (
    <div className="form">
      ...
      <TextField error={props.error} onChange={props.handleChange} fullWidth label="Phone Number" placeholder="Enter Phone Number" type="number" name="phone" margin="normal" />
